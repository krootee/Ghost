...
int tca9548_set_channel(int channel)
{

  //Contact the TCA9548. Does it respond?
...
// esp_err_t tca9548_get_channel()
// {
//   i2c_cmd_handle_t cmd = i2c_cmd_link_create();
//   i2c_master_start(cmd);
//   i2c_master_write_byte(cmd, (TCA_ADDRESS << 1 | I2C_MASTER_READ))
// }
