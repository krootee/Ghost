...
U 1 1 5898F42A
P 7350 4900
F 0 "U4" H 7600 4550 60  0000 C CNN
F 1 "TSOP753" H 7400 5150 60  0000 C CNN
F 2 "NorBotKiCadFootprints:TSOP75x" H 7300 5050 60  0001 C CNN
...
U 1 1 5898FEA1
P 6500 4950
F 0 "C1" H 6525 5050 50  0000 L CNN
F 1 "0.1uF" H 6525 4850 50  0000 L CNN
...
U 1 1 58990394
P 6200 4800
F 0 "R2" V 6280 4800 50  0000 C CNN
F 1 "100" V 6200 4800 50  0000 C CNN
F 2 "Resistors_SMD:R_0603_HandSoldering" V 6130 4800 50  0001 C CNN
...
U 1 1 589906CA
P 5950 4750
F 0 "#PWR039" H 5950 4600 50  0001 C CNN
F 1 "+3V3" H 5950 4890 50  0000 C CNN
...
Text GLabel 8000 4800 2    39   Input ~ 0
GPIO_IR
Wire Wire Line
	8000 4800 7850 4800
Wire Wire Line
	5950 4800 6050 4800
Text Notes 6900 4500 0    39   ~ 0
Infrared Receiver, 38kHz\n(May optionally replace StartModule)\nTSOP75538WTR, Farnell no: 225-1430 (or similar)\nVoltage: 2.5-5.5V
$Sheet
S 9150 5400 1200 750 
U 5899267F
F0 "FreeIMU" 39
F1 "FreeIMU.sch" 39
F2 "VCC" I L 9150 5600 60 
F3 "INT" I L 9150 5750 60 
F4 "FSYNC" I L 9150 5900 60 
F5 "GND" I L 9150 6050 60 
F6 "DRDY" I R 10350 5600 60 
F7 "SCL" I R 10350 5750 60 
F8 "SDA" I R 10350 5900 60 
$EndSheet
$Comp
L +3V3 #PWR040
U 1 1 589936A6
P 8950 5600
F 0 "#PWR040" H 8950 5450 50  0001 C CNN
F 1 "+3V3" H 8950 5740 50  0000 C CNN
F 2 "" H 8950 5600 50  0000 C CNN
F 3 "" H 8950 5600 50  0000 C CNN
	1    8950 5600
	1    0    0    -1  
$EndComp
Text GLabel 8950 5750 0    39   Input ~ 0
GPIO_INT
...
GPIO_SCL
Text GLabel 10500 5600 2    39   Input ~ 0
GPIO_DRDY
Wire Wire Line
	9150 5600 8950 5600
Wire Wire Line
...
U 1 1 589CADB2
P 6900 5200
F 0 "#PWR060" H 6900 4950 50  0001 C CNN
...
U 1 1 58ABBBC8
P 6500 4750
F 0 "#FLG061" H 6500 4845 50  0001 C CNN
F 1 "PWR_FLAG" H 6500 4930 50  0000 C CNN
